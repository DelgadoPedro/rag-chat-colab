...
O sistema foi desenvolvido para um **cenário acadêmico de estudo colaborativo**, onde um grupo de estudantes trabalha em conjunto para preparar-se para uma avaliação sobre um tema específico (ex: MLOps, Machine Learning, Sistemas Distribuídos, etc.).

### Participantes

O sistema simula um ambiente de **5 participantes** pré-configurados:
- **Artur**
- **Pedro**
- **João**
- **Rebeca**
...
## 🎯 Abordagem dos 3C: Communication, Coordination, Cooperation

O sistema implementa os **3C (Communication, Coordination, Cooperation)** da teoria de sistemas colaborativos de forma integrada e complementar. Cada componente trabalha em conjunto para criar uma experiência colaborativa eficaz.

---

## 📢 1. COMMUNICATION (Comunicação)
...
**Desenvolvido para**: Trabalho Acadêmico - Sistemas Colaborativos  
**Tema**: Chat Colaborativo com RAG e Assistente IA  
**Abordagem**: Implementação prática dos 3C em sistema real
